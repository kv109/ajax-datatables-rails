  ...
  ActionController::Parameters.new(
    {
      ...
      'columns' => {
        ...
        '4' => {
          'data' => 'role_id', 'name' => '', 'searchable' => 'true', 'orderable' => 'true',
          'search' => {
            'value' => '', 'regex' => 'false'
          }
        },
